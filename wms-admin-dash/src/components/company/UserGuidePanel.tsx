...
const SECTIONS: GuideSection[] = [
  ...
  },
  {
    ...
    statuses: [
      ...
      { label: 'Fulfilled', meaning: 'Order fully shipped / closed on Linker side.' },
      { label: 'Error', meaning: 'Pipeline failed — check lastError and Failed queue.' },
      { label: 'Return', meaning: 'Linked to RMA activity — use Returns for the full workflow.' },
  ...
  },
  {
    ...
    statuses: [
      { label: 'requested → authorized', meaning: 'Approve the RMA so warehouse expects goods.' },
      ...
      { label: 'restocked / scrapped → refunded or exchanged', meaning: 'Close the commercial outcome in Linker (not Shopify refund API).' },
      { label: 'cancelled', meaning: 'Stop the RMA; terminal.' },
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'orders', meaning: 'View, allocate, fulfill orders.' },
      ...
      { label: 'sftp', meaning: 'Named SFTP connections.' },
      { label: 'routing', meaning: 'Routing rules and policies.' },
      { label: 'email', meaning: 'SMTP and alert toggles.' },
